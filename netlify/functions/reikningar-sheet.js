...
exports.handler = async (event) => {
  ...
  try {
    ...
    const header = ['Fyrirtæki', 'Heimilisfang', 'Kennitala', 'Reikningsnúmer', 'Dagsetning', 'Heildarupphæð', 'Ár', 'Viðskiptavinur (grunnur)', 'Skráarnafn', 'Tengill'];
    const values = [header].concat(rows.map(r => [
      r.company || '', r.address || '', r.kt || '', r.invoice_number || '',
